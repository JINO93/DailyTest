    ...
    private int getHeight() {
        ...
        if (getContext() != null) {
            ...
            if (wm != null) {
                ...
                height = point.y - getTopOffset() - ViewUtils.getStatusBarHeight(getActivity());
            }
//            height = ViewUtils.getDisplayHeight(getContext()) - getTopOffset();
        }
        if (ViewUtils.isNavBarVisible(getActivity().getWindow(),getActivity())) {
            height -= ViewUtils.getNavBarHeight(getActivity());
        }
        return height;
    }
    ...
    private class BottomDialog extends BottomSheetDialog {
        ...
        private void init() {
//            View root = mWindow.findViewById(android.support.design.R.id.coordinator);
//            if (root != null) {
